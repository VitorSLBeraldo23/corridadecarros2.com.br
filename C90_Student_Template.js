...
function car1_left()
{
	...
	{
		car1X = car1X - 10;
		console.log("Quando a seta para esquerda for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1X = car1X + 10;
		console.log("Quando a seta para direita for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up()
{
	...
	{
		car2Y = car2Y - 10;
		console.log("Quando a tecla W for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down()
{
	...
	{
		car2Y = car2Y + 10;
		console.log("Quando a tecla S for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2X = car2X - 10;
		console.log("Quando a tecla A for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2X = car2X + 10;
		console.log("Quando a tecla D for pressionada , X = " + car1X + "Y = " + car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
